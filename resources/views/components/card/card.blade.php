<div class="m-3 p-3 flex flex-wrap justify-center content-between rounded-xl shadow-lg border border-1 border-gray-400 h-44 transform transition-all duration-500 hover:shadow-2xl hover:-translate-y-3">
  ...
  <div class="w-full flex flex-col items-center justify-center">
    <p class="text-gray-800 w-full break-words">{{ $description }}</p>
  </div>

  {{-- Footer --}}
  <div class="w-full flex flex-wrap space-x-3 space-y-1 items-center justify-between">
    @foreach($tags as $tag)
