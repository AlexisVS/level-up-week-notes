          ...
          <x-slot name="status">
            ...
            <form action="/global-note/unlike/{{ $note->id }}" method="POST">
              ...
              <button type="submit" class="border-0 bg-transparent">
                <svg version="1.1" class="w-5 h-5" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 512.002 512.002" style="enable-background:new 0 0 512.002 512.002;" xml:space="preserve">
